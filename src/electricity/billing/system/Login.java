...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        ImageIcon i1 = new ImageIcon(Splash.class.getResource("/icon/login.png"));
        ...
        ImageIcon i4 = new ImageIcon(Splash.class.getResource("/icon/cancel.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(Splash.class.getResource("/icon/signup.png"));
        ...
        ImageIcon i10 = new ImageIcon(Splash.class.getResource("/icon/second.jpg"));
