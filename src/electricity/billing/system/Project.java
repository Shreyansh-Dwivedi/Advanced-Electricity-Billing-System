...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter){
       this.atype = atype;
        ...
        ImageIcon i1 = new ImageIcon(Project.class.getResource("/icon/elect1.jpg"));
        ...
        ImageIcon icon1 = new ImageIcon(Project.class.getResource("/icon/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(Project.class.getResource("/icon/icon2.png"));
        ...
        ImageIcon icon3 = new ImageIcon(Project.class.getResource("/icon/icon3.png"));
        ...
        ImageIcon icon4 = new ImageIcon(Project.class.getResource("/icon/icon5.png"));
        ...
        ImageIcon icon5 = new ImageIcon(Project.class.getResource("/icon/icon4.png"));
        ...
        ImageIcon icon6 = new ImageIcon(Project.class.getResource("/icon/icon6.png"));
        ...
        ImageIcon icon7 = new ImageIcon(Project.class.getResource("/icon/icon4.png"));
        ...
        ImageIcon icon8 = new ImageIcon(Project.class.getResource("/icon/icon6.png"));
        ...
        ImageIcon icon9 = new ImageIcon(Project.class.getResource("/icon/icon7.png"));
        ...
        ImageIcon icon10 = new ImageIcon(Project.class.getResource("/icon/icon12.png"));
        ...
        ImageIcon icon11 = new ImageIcon(Project.class.getResource("/icon/icon9.png"));
        ...
        ImageIcon icon12 = new ImageIcon(Project.class.getResource("/icon/icon11.png"));
